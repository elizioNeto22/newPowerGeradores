...
<head>
  ...
  <meta content="Manutenção de geradores com atendimento 24 horas - Equipe especializada em Pernambuco - Telefone(81) 3204-7949 - Whatsapp - 99231-4540 - Ligue agora e faça um orçamento." name="description">
  <meta content="manutenção de geradores em recife, manutenção de geradores em pernambuco, manutenção preventiva de geradores em recife, manutenção preventiva de geradores em pernmabuco, manutenção corretiva de geradores em recife, manutenção corretiva de geradores em pernambuco, geradores de energia, power, geradores eletricos, geradores recife, grupo geradores, instalação geradores, vendas de geradores, automação de geradores" name="keywords">
  ...
  <script src="enviaForm.js?n=<?php echo time();?>"></script>
          ...
          <div class="col-12 col-lg-7">
            ...
            <div class="row">
              ...
              <div class="col-lg-6 col-12 icon-box m-lg-0" data-aos="fade-up" data-aos-delay="300">
                ...
                <h4 class="title"><a href="instalacao.php">INSTALAÇÃO</a></h4>           
              </div>                    
            </div>
          </div>
    ...
    <section id="acoes" class="portfolio section-bg px-3 px-lg-5 pt-lg-5 border-bottom">
      <div class="container pt-5 pt-lg-0">
        ...
        <div class="row portfolio-container" data-aos="fade-up">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-quadros">
            <div class="portfolio-wrap">
              <img src="assets/img/acoes/01.jpg" class="img-fluid" alt="">              
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-manutencao">
            <div class="portfolio-wrap">
              <img src="assets/img/acoes/02.jpg" class="img-fluid" alt="">              
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-quadros">
            <div class="portfolio-wrap">
              <img src="assets/img/acoes/03.jpg" class="img-fluid" alt="">             
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-instalacao">
            <div class="portfolio-wrap">
              <img src="assets/img/acoes/04.jpg" class="img-fluid" alt="">              
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-manutencao">
            <div class="portfolio-wrap">
              <img src="assets/img/acoes/05.jpg" class="img-fluid" alt="">              
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-quadros">
            <div class="portfolio-wrap">
              <img src="assets/img/acoes/06.jpg" class="img-fluid" alt="">              
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-instalacao">
            <div class="portfolio-wrap">
              <img src="assets/img/acoes/07.jpg" class="img-fluid" alt="">              
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-instalacao">
            <div class="portfolio-wrap">
              <img src="assets/img/acoes/08.jpg" class="img-fluid" alt="">                          
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-manutencao">
            <div class="portfolio-wrap">
              <img src="assets/img/acoes/09.jpg" class="img-fluid" alt="">              
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-manutencao">
            <div class="portfolio-wrap">
              <img src="assets/img/acoes/10.jpg" class="img-fluid" alt="">              
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-manutencao">
            <div class="portfolio-wrap">
              <img src="assets/img/acoes/11.jpg" class="img-fluid" alt="">              
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-manutencao">
            <div class="portfolio-wrap">
              <img src="assets/img/acoes/12.jpg" class="img-fluid" alt="">              
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-manutencao">
            <div class="portfolio-wrap">
              <img src="assets/img/acoes/13.jpg" class="img-fluid" alt="">              
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-manutencao">
            <div class="portfolio-wrap">
              <img src="assets/img/acoes/14.jpg" class="img-fluid" alt="">              
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-manutencao">
            <div class="portfolio-wrap">
              <img src="assets/img/acoes/15.jpg" class="img-fluid" alt="">              
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-manutencao">
            <div class="portfolio-wrap">
              <img src="assets/img/acoes/16.jpg" class="img-fluid" alt="">              
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-manutencao">
            <div class="portfolio-wrap">
              <img src="assets/img/acoes/17.jpg" class="img-fluid" alt="">              
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-manutencao">
            <div class="portfolio-wrap">
              <img src="assets/img/acoes/18.jpg" class="img-fluid" alt="">              
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-manutencao">
            <div class="portfolio-wrap">
              <img src="assets/img/acoes/19.jpg" class="img-fluid" alt="">              
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-manutencao">
            <div class="portfolio-wrap">
              <img src="assets/img/acoes/20.jpg" class="img-fluid" alt="">              
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-manutencao">
            <div class="portfolio-wrap">
              <img src="assets/img/acoes/21.jpg" class="img-fluid" alt="">              
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-manutencao">
            <div class="portfolio-wrap">
              <img src="assets/img/acoes/22.jpg" class="img-fluid" alt="">              
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-manutencao">
            <div class="portfolio-wrap">
              <img src="assets/img/acoes/23.jpg" class="img-fluid" alt="">              
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-manutencao">
            <div class="portfolio-wrap">
              <img src="assets/img/acoes/24.jpg" class="img-fluid" alt="">              
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-manutencao">
            <div class="portfolio-wrap">
              <img src="assets/img/acoes/25.jpg" class="img-fluid" alt="">              
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-manutencao">
            <div class="portfolio-wrap">
              <img src="assets/img/acoes/26.jpg" class="img-fluid" alt="">              
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-manutencao">
            <div class="portfolio-wrap">
              <img src="assets/img/acoes/27.jpg" class="img-fluid" alt="">              
            </div>
          </div>
      ...
      <div class="container pt-5 pt-lg-0">
        ...
        <div class="row" data-aos="fade-in">          
          ...
          <div class="col-12 px-0 px-lg-3">
            <div class="info">
              <div class="row">               
              <form method="POST" class="php-email-form pt-0 px-3 px-lg-5" action="/contact" id="form-confirm-othuki" name="form-confirm-othuki">            
                    <div class="form-row">
              ...
              <div class="row">               
                <div class="col-sm">
                    ...
                    <div class="row">
                      <div class="col">
                        ...
                        <h4>Matriz: (Rio)</h4>
                        <p class="m-0">Av. Pastor Martin Luther King Jr, 126 - Torre 3 (Nova América Office)
                        Sl 1416 Del Castilho – Rio de Janeiro/RJ<br />CEP 20765-000</p>
                      </div>
                    </div>
                ...
                <div class="col-sm d-flex align-items-start flex-column">
                  <div class="mt-2 mt-lg-0">
                    <i class="icofont-google-map"></i>
                    <h4>Filial: (Recife)</h4>
                    <p class="m-0"> Estr. do Arraial, 2948 - Loja 116 - Tamarineira, Recife - PE, 52051-380</p>
                  </div>
