...
<head>
  ...
  <title>Parceiros Autorizados - New Power Grupos Geradores</title>
    ...
    .nav-menu {
      ...
      <nav class="nav-menu">
        ...
        <div class="accordion d-lg-none d-block" id="accordionExample">
          ...
          <li class="active"><a href="#"><i class="icofont-listine-dots"></i> <span>Parceiros Autorizados</span></a></li>          
    ...
    <section id="produtos" class="about px-3 px-lg-5 pt-2 pt-lg-0 border-bottom">
      <div class="container pt-2 pt-lg-0">
        ...
        <div class="section-title mt-4">         
          <p class="text-justify">Somos uma autorizada Maxi Trust, fornecemos manutenção, instalação e venda de grupos geradores.</p>          
        </div>
            ...
            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img class="d-block w-100" src="assets/img/produtos/produtos-6.jpeg" alt="Primeiro Slide" style="border-radius: 11px;">
                  </div>
          ...
          <section id="cta" class="cta mt-4 w-100" data-aos="fade-right">
              <div class="container aos-init aos-animate" data-aos="zoom-in">
                <div class="text-center">
                    ...
                    <img class="d-block w-100" src="assets/img/maxitrust.jpeg" alt="Primeiro Slide" style="border-radius: 11px;">
                  </p>                  
                </div>
              </div>
          </section>
